...
function SC:_BuildButtons(f)
    ...
    sell:SetSize(90, 24); sell:SetPoint("BOTTOMRIGHT", -16, 12); sell:SetText(L["Sell all"])
    sell:SetScript("OnClick", function() SC:Confirm() end)
    local clear = CreateFrame("Button", nil, f, "UIPanelButtonTemplate")
    clear:SetSize(70, 24); clear:SetPoint("RIGHT", sell, "LEFT", -8, 0); clear:SetText(L["Clear"])
